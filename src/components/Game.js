...
function Game() {
  ...
  const [computerImage, setComputerImage] = useState(paper);
  ...
  const animationHandler = () => {
    ...
    setShakeAnimation('shakePlayer 2s ease');
  };
  ...
  const playerClickHandler = (hand) => {
    ...
    setTimeout(() => {
      ...
      compareHands();
      //   // update images
      //   setPlayerImage(`../assets/${hand}.png`);
          ...
          <div className='row'>
            <div className='col-md-12 text-center'>
              ...
              >
                ...
                <div className='hands'>
                  <img className='player-hand' src={playerImage} alt='' />
                  <img className='computer-hand' src={computerImage} />
                </div>
